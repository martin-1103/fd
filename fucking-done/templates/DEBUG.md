...
Template for `.fd/planning/debug/[slug].md` — active debug session tracking.
...
**Creation:** Immediately when /fd:debug is called
...
**On resolution:**
- status → "resolved"
- Move file to .fd/planning/debug/resolved/
