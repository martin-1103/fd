...
Template for `.fd/planning/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Claude cannot automate.
...
**Searchability:** `grep -r "USER-SETUP" .fd/planning/` finds all phases with user requirements.
