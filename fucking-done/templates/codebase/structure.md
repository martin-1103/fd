...
Template for `.fd/planning/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── fd/           # FD-specific commands
├── fucking-done/     # Skill resources
...
**fucking-done/templates/**
- Purpose: Document templates for .fd/planning/ files
...
**New Slash Command:**
- Primary code: `commands/fd/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `fucking-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `fucking-done/workflows/{name}.md`
- Usage: Reference from command with `@/root/.claude/fucking-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `fucking-done/references/{name}.md`
