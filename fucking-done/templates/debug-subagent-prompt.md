...
Template for spawning fd-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
<debug_file>
Create: .fd/planning/debug/{slug}.md
</debug_file>
```
...
```python
Task(prompt=template, subagent_type="fd-debugger", description="Debug UAT-001")
```
...
<prior_state>
Debug file: @.fd/planning/debug/{slug}.md
</prior_state>
